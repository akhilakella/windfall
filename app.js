...
const TOUR_SLIDES = [
  ...
  { emoji: "🌳", title: "Report a tree", body: "Found a tree full of fruit? Tap the plus button, drop a pin on the map, add a few notes, and take or upload a photo. It only takes a moment, and every tree you add helps someone else find fruit nearby." },
  { emoji: "🔎", title: "Check the fruit", body: "Not sure whether the fruit is any good? Use the fruit checker. Take a photo and it will tell you whether the fruit looks fresh and ready, only fit for animals or cider, or best left alone. Think of it as a quick second opinion before you pick or eat." },
  { emoji: "🧺", title: "Log your pickup", body: "Rescued some fruit? Open the tree and record how many kilograms you collected and where it went, such as eaten fresh, animal feed, juice, baking, donated, or the green food waste bin. You can add a photo of your haul too. Every pickup builds our community total." },
  { emoji: "🌿", title: "Pick responsibly", body: "A few simple rules keep this good for everyone. Only pick from public land or where you have the owner's permission. Take what you will use and leave plenty for others and for wildlife. Give everything a wash before eating, and never pick anything you are unsure about." },
  { emoji: "🔔", title: "Stay in the loop", body: "When someone picks fruit from a tree you reported, or leaves a comment on it, you will get a notification in the app and by email, so you always know what is happening with your trees. You can turn those emails on or off any time in your profile." },
  { emoji: "🏆", title: "Badges, rankings and our goal", body: "Every kilogram counts towards your badges and your place on the Warwickshire leaderboard. Together we are aiming to rescue one tonne of fruit this year, and you can watch that total climb. Use the bell for updates, the megaphone for news, and the calendar to see what is in season. Time to rescue some fruit." }
];
let tourIndex = 0;
