...
const FEATURES = [
  ...
  ["Web push notifications",          [R.route("/api/push/subscribe"), R.route("/api/push/unsubscribe"), R.route("/api/push/public-key"), R.srvfn("sendPush"), R.srvfn("broadcastPush"), R.fn("enablePush"), R.fn("autoEnablePush"), R.fn("urlBase64ToUint8Array"), R.id("pushPrefToggle"), { label: "sw.js push handler", test: () => swJs.includes('addEventListener("push"') }]],
